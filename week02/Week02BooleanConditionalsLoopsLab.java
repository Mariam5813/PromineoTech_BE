...
public class Week02BooleanConditionalsLoopsLab {
	...
	public static void main(String[] args) {
		...
		if (age>=16) {
			...
			System.out.println("You cannnot drive");
		}
		...
		double costOfmilk=2.40;
		int thirstLevel=7;
		
		if (costOfmilk<2.50 && thirstLevel>6 ) {
			System.out.println("Milk plase");
		} else {
		...
		//				loyaltyMemberStatus from SILVER to GOLD or from GOLD to PLATINUM
                ...
                if (adjustedTotal>500 && loyaltyMemberStatus !="PLATINUM" )
                ...
                System.out.println("Ststus is " + loyaltyMemberStatus +" Total bill is "+ adjustedTotal );
