...
public class GameBoard {
	...
	public void display() {
		...
		for (int i=1; i<=board.length;i=i+3) {
			System.out.print("     | "+board[i-1]+" | "+board[i]+" | "+board[i+1]+" |\n");
			System.out.println("     +---+---+---+"); 
		}
		
	}

	public boolean isValidSetSquare(int squarenum, String readInput, String player) {
		if (this.board[squarenum-1].equals(readInput)) {
